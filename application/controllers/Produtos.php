...
class Produtos extends CI_Controller
{
    ...
    function adicionar()
    {
        ...
        if ($this->form_validation->run('produtos') == false) {
            ...
            if (!validate_money($precoCompra)) {
                $precoCompra = str_replace(array('.', ','), array('', '.'), $precoCompra);
            }
            if (!validate_money($precoVenda)) {
                $precoVenda = str_replace(array('.', ','), array('', '.'), $precoVenda);
            }
...
//        $this->db->delete('itens_de_vendas');
        ...
        $this->produtos_model->delete('produtos', $data, 'idProdutos', $id);
