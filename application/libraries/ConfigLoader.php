...
class ConfigLoader
{
    ...
    public function __construct()
    {
        ...
        // TODO: disponibilizar opção para o usuario escolher a cor do tema (menu lateral + barra de navegação)
        $config['sidebarClass']    = 'sidebar-midnightblue';
        $config['navbarClass']     = ENVIRONMENT == 'development' ? 'navbar-danger' : 'navbar-midnightblue';
