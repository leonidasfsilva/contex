    ...
    <div class="col-md-12">
        <div class="panel panel-midnightblue" id="painel_chamado">
            <div class="panel-heading">
                <h2 class="pull-left mt0 mb0">Chamado: # <?= $chamado->id_chamado . ' - ' . $chamado->assunto ?></h2>
            ...
            <div class="panel-body mailbox-panel">
                ...
                <div class="panel-footer">
                    <form id="formResponderChamado" action="<?php echo base_url('chamados/responderChamado/'. $chamado->id_chamado) ?>" method="post" autocomplete="off">
...
<div class="modal fade" id="modalFinalizarChamado" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="formPagar" action="<?php echo base_url('chamados/finalizar') ?>" method="post" autocomplete="off">
                <div class="modal-body">
                    <p>Deseja realmente marcar este chamado como FINALIZADO?</p>
                    <input id="id_chamado" type="hidden" name="id_chamado" value=""/>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-default btn-sm" data-dismiss="modal" aria-hidden="true">
                    ...
                    <button type="submit" class="btn btn-inverse btn-sm">
                        <i class="fa fa-check fa-fw"></i> Finalizado
                    </button>
                </div>
            </form>
        </div>
