...
<section id="wrapper" class="login-register">
    <div class="login-box login-sidebar">
        ...
        <div class="white-box box-login">
            <form class="form-horizontal floating-labels" id="formLogin" method="post" action="<?php echo base_url() ?>conecte/verificarLogin">
                <div class="preloader-login">
                    <div class="cssload-speeding-wheel"></div>
                </div>
                <div class="before-loading">
                    <div class="form-group">
                        <h3 class="font-bold m-b-40">Acesso para clientes</h3>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group text-center m-t-20">
                        <div class="row">
                            <div class="col-xs-6">
                                <a href="<?php echo base_url() ?>" class="btn btn-default btn-block waves-effect waves-light"><i class="fas fa-arrow-left fa-fw"></i> Voltar</a>
                            </div>
                            <div class="col-xs-6">
                    ...
                    <!--                            <p>Não tem uma conta? <a href="--><?php //echo base_url() ?><!--conecte/cadastro" class="text-primary"><b>Cadastre-se</b></a>.</p>-->
                    <!--                        </div>-->
                    <!--                    </div>-->
                </div>
            </form>
