    ...
    <ul class="nav navbar-nav toolbar pull-right">
        ...
        <li class="dropdown toolbar-icon-bg">
            ...
            <ul class="dropdown-menu userinfo arrow">
                ...
                <li title="Dados da conta"><a href="<?php echo site_url(); ?>conecte/conta"><span class="pull-left">Minha Conta</span> <i class="pull-right fas fa-user-cog fa-lg"></i></a></li>
                ...
                <li class="divider"></li>
                <li title="Encerrar sessão"><a href="<?php echo site_url(); ?>conecte/sair"><span class="pull-left">Sair</span> <i class="pull-right fas fa-power-off fa-lg"></i></a></li>
            </ul>
        </li>
        <!--MENU USUARIO-->
    </ul>
                        ...
                        <nav role="navigation" class="widget-body">
                            <ul class="acc-menu">
                                ...
                                <li class="<?= (isset($menuPainel)) ? 'active' : ''; ?>">
                                    <a href="<?php echo base_url().'conecte/painel' ?>"><i class="fas fa-home fa-fw"></i>
                ...
                <div class="page-content">
                    ...
                    <div class="container-fluid conteudo-principal">
                        ...
                        <div class="subconteudo-principal">
                            <?php if (isset($output)) {
                                echo $this->load->view($output, null, true);
                            } ?>
                        </div>
                        <!--CONTEUDO PRINCIPAL-->
