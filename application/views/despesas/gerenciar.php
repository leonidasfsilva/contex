<?php
$status_despesas    = $this->input->get('status');
$tipo_despesas      = $this->input->get('tipo');
$periodo_despesas   = $this->input->get('periodo');
...
?>
    <div class="panel panel-midnightblue">
        <div class="panel-heading">
            <h3>
                <i class="fas fa-receipt fa-lg fa-fw"></i>
                Despesas
            </h3>
            <div class="row mr5 ml5">
                <div class="panel-ctrls ml5">
                    <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'aDespesas')) { ?>
                        <a href="#modalDespesa" id="saida" data-toggle="modal" role="button" class="btn btn-primary btn-sm tip-bottom" title="Registrar nova despesa">
                    ...
                    <div class="row">
                        <div class="form-group col-lg-6">
                            ...
                            <select class="form-control" id="select_tipo" name="tipo">
                                ...
                                <option value="entrada" <?php if ($tipo_despesas == 'entrada') {
                                                            echo 'selected';
                                                        } ?>>ENTRADA
                                </option>
                                <option value="saida" <?php if ($tipo_despesas == 'saida') {
                                                            echo 'selected';
                                                        } ?>>SAÍDA
                                </option>
                            </select>
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <select class="form-control" id="select_status" name="status">
                                ...
                                <option value="efetivado" <?= ($status_despesas == 'efetivado') ? 'selected' : null ?>>EFETIVADO
                                </option>
                                <option value="pendente" <?= ($status_despesas == 'pendente') ? 'selected' : null ?>>PENDENTE
                                </option>
                            </select>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-lg-6" style="margin-left: 0">
                            ...
                            <select name="periodo" id="select_periodo" class="form-control">
                                ...
                                <option value="todos" <?php if ($periodo_despesas == 'todos') {
                                                            echo 'selected';
                                                        } ?>>Todos
                                </option>
                                <option value="3dias" <?php if ($periodo_despesas == '3dias') {
                                                            echo 'selected';
                                                        } ?>>Últimos 3 dias
                                </option>
                                <option value="5dias" <?php if ($periodo_despesas == '5dias') {
                                                            echo 'selected';
                                                        } ?>>Últimos 5 dias
                                </option>
                                <option value="7dias" <?php if ($periodo_despesas == '7dias') {
                                                            echo 'selected';
                                                        } ?>>Últimos 7 dias
                                </option>
                                <option value="15dias" <?php if ($periodo_despesas == '15dias') {
                                                            echo 'selected';
                                                        } ?>>Últimos 15 dias
                                </option>
                                <option value="30dias" <?php if ($periodo_despesas == '30dias') {
                                                            echo 'selected';
                                                        } ?>>Últimos 30 dias
                                </option>
                                <option value="60dias" <?php if ($periodo_despesas == '60dias') {
                                                            echo 'selected';
                                                        } ?>>Últimos 60 dias
                                </option>
                                <option value="90dias" <?php if ($periodo_despesas == '90dias') {
                                                            echo 'selected';
                                                        } ?>>Últimos 90 dias
                                </option>
                                <option value="mensal" <?php if (
                                                            $periodo_despesas == 'mensal' ||
                                                            !$periodo_despesas
                                                        ) {
                                                            echo 'selected';
                                                        } ?>>MÊS/ANO ESPECÍFICOS
                                </option>
                                <option value="especifico" <?php if ($periodo_despesas == 'especifico') {
                                                                echo
                                                                'selected';
                                                            } ?>>PERÍODO ESPECÍFICO
                                </option>
...
<div class="modal fade" id="modalDespesa" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="formRegistrar" action="<?= base_url('financeiro/despesas/registrar') ?>" method="post" autocomplete="off">
                <div class="modal-body">
                    <div class="row">
                        <div class="form-group col-lg-12">
                            ...
                            <input type="hidden" class="urlAtual" name="urlAtual" value="" />
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-lg-12">
                            <label class="font-weight-bold" for="descricao">Favorecido</label>
                            <input class="form-control favorecido" type="text" name="favorecido" />
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-lg-6">
                        ...
                        <div class="form-group col-lg-6">
                            <label for="data_compra" class="font-weight-bold">Vencimento</label>
                    ...
                    <div class="row divContainerParcelamento">
                        <div class="form-group col-lg-4" style="margin-top: -10px;" id="div_parcelada">
                            <div class="checkbox icheck">
                                <input type="checkbox" class="form-control parcelada" name="despesa_parcelada" value="1">
                            </div>
                            <label for="parcelada" class="font-weight-bold">Despesa parcelada?</label>
                        </div>
                        <div id="divParcelamento" class="hidden">
                            <div class="form-group col-lg-4">
                                <label for="qnt_parcelas" class="font-weight-bold">Nº parcelas *</label>
                                <input type="text" name="qnt_parcelas" id="qnt_parcelas" class="form-control qntParcelas">
                            </div>
                            <div class="form-group col-lg-4">
                                <label for="valor_parcela" class="font-weight-bold">Valor parcela *</label>
                                <input class="form-control money valorParcela" id="valor_parcela" type="text" name="valor_parcela" readonly />
                            </div>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <div class="row">
                        <div class="text-left col-xs-4" style="margin-top: -10px;">
                            <div class="checkbox icheck">
                                <input type="checkbox" class="form-control recorrente" name="recorrente" value="1">
                            </div>
                            <label class="font-weight-bold">Recorrente?</label>
                        </div>
                        <div class="col-xs-8">
...
<script type="text/javascript">
    ...
    $(".favorecido").autocomplete({
        ...
        minLength: 1,
        select: function(event, ui) {
            $(".favorecido").val(ui.item.label);
        }
    });

    $('#modalDespesa').on('shown.bs.modal', function(e) {
        $('.descricao').focus();
    })
    ...
    $('.recorrente').on('ifChanged', function(event) {
        mudaICheckRecorrente(event);
    });
    ...
    function mudaICheckRecorrente(event) {
        const checked = event.target.checked;
        if (checked == true) {
    ...
    jQuery(document).ready(function($) {
        ...
        $("#formRegistrar").validate({
            ...
            messages: {
                ...
                valor_parcela: {
                    required: 'Informe o valor e as parcelas'
                },
                qnt_parcelas: {
                    required: 'Informe as parcelas',
                    number: 'Apenas números',
                    min: 'Mínimo de parcelas: 2',
                    max: 'Máximo de parcelas: 48'
                },
                vencimento: {
                    required: 'Campo obrigatório'
                },
