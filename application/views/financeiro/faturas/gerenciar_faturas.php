...
<form id="form_detalhes" action="<?php echo base_url(); ?>financeiro/faturas/detalhes" method="post">
    <input type="hidden" id="id_fatura_detalhes" name="id_fatura">
    <input type="hidden" id="urlDetalhesFatura" name="urlAtual">
    <input type="hidden" name="method" value="detalhes">
</form>
            ...
            <form id="formNovaFatura" action="<?php echo base_url() ?>financeiro/faturas/abrir" method="post" autocomplete="off">
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <input id="urlFatura" type="hidden" name="urlAtual" value=""/>
                    </div>
                </div>
                <div class="modal-footer">
