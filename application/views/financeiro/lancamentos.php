                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="form-group col-lg-12">
                            ...
                            <input class="form-control descricao descricao-autocomplete" id="descricao" type="text" name="descricao"/>
            ...
            <form id="formDespesa" action="<?= base_url('financeiro/lancamentos/saida') ?>" method="post" autocomplete="off">
                <div class="modal-body">
                    <div class="row">
                        <div class="form-group col-lg-12">
                            <label class="font-weight-bold" for="descricao">Descrição *</label>
                            <input class="form-control descricao descricao-autocomplete" type="text" name="descricao"/>
