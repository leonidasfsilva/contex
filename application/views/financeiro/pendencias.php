    ...
    <div class="panel-heading">
        ...
        <div class="panel-ctrls">
            ...
            <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'aLancamento')) { ?>
                <a href="#modalPendencia" id="pendencia" data-toggle="modal" role="button" class="btn btn-primary btn-sm tip-bottom" title="Registrar nova pendência">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="form-group col-lg-12">
                            ...
                            <input class="form-control" id="nome_cliente" type="text" name="nome_cliente" placeholder="Informe o nome do cliente" />
    ...
    $(document).ready(function($) {
        ...
        $("#formPendencia").validate({
            ...
            messages: {
                ...
                tipo: {
                    required: 'Selecione o tipo de pendência'
                },
            },
        ...
        $(document).on('click', '.editar', function(event) {
            let id = $(this).attr('id_cliente')

            $.ajax({
                type: "POST",
                url: "<?php echo base_url('financeiro/pendencias/getClientName'); ?>",
                data: {
                    clientId: id
                },
                dataType: 'json',
                success: function(result) {
                    if (result.success == true) {
                        $("#nome_clienteEditar").val(result.data.nome);
                    }
                }
            });
