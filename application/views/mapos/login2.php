        ...
        <div class="login-box login-sidebar">
            <div class="white-box">
                <form class="form-horizontal form-material" id="loginform" action="index.html">
                    <a href="javascript:void(0)" class="text-center db"><img src="../plugins/images/agileadmin-logo-dark.png" alt="Home" />
                        <br/><img src="../plugins/images/agileadmin-text-dark.png" alt="Home" /></a>
