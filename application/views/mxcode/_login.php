...
<head>
        <title>MX CODE - Sistemas Web</title><meta charset="UTF-8" />
        ...
        <div id="loginbox">            
            <form  class="form-vertical" id="formLogin" method="post" action="<?php echo base_url()?>index.php/mapos/verificarLogin">
                ...
                <div class="control-group">
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on bg_lg"><i class="fa fa-user fa-fw"></i></span>
                ...
                <div class="control-group">
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on bg_lb"><i class="fa fa-lock fa-fw"></i></span>
                ...
                <div class="form-actions" style="text-align: center">
                    ...
                    <button id="btn-acessar" class="btn btn-success"/><i class="fa fa-sign-in fa-fw"></i> Entrar</button>
                </div>
            </form>
        </div>
