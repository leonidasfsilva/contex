                            ...
                            <div class="span12" id="divCadastrarOs">
                                ...
                                <form action="<?php echo current_url(); ?>" method="post" id="formOs">
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        ...
                                        <div class="span6">
                                            <label for="tecnico">Funcionário<span class="required">*</span></label>
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        ...
                                        <div class="span3">
                                            ...
                                            <input id="dataInicial" class="span12 datepicker" type="text" name="dataInicial"
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        ...
                                        <div class="span6">
                                            ...
                                            <textarea class="span12" name="descricaoProduto" id="descricaoProduto" cols="30"
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        <div class="span6 offset3" style="text-align: center">
                                            <?php if ($result->faturado == 0) { ?>
                                                <a href="#modal-faturar" id="btn-faturar" role="button" data-toggle="modal" class="btn btn-success"><i class="icon-file"></i>
                                                    Faturar</a>
                                            <?php } ?>
                                            <button class="btn btn-primary" id="btnContinuar"><i class="icon-white icon-ok"></i> Alterar</button>
                                            <a href="<?php echo base_url() ?>index.php/os/visualizar/<?php echo $result->idOs; ?>" class="btn btn-inverse"><i
                                                        class="icon-eye-open"></i> Visualizar OS</a>
                            ...
                            <div class="span12" id="divProdutos" style="margin-left: 0">
                                <table class="table table-bordered" id="tblProdutos">
                                    ...
                                    <tr>
                                        ...
                                        <td><strong>R$ <?php echo number_format($total, 2, ',', '.'); ?><input type="hidden" id="total-venda"
                                ...
                                <div class="span12" id="divServicos" style="margin-left: 0">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td><strong>R$ <?php echo number_format($total, 2, ',', '.'); ?><input type="hidden" id="total-servico"
                                                                                                                   value="<?php echo number_format($total, 2); ?>"></strong></td>
                                        </tr>
                                        </tbody>
                                    </table>
