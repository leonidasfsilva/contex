            ...
            <div class="widget-content nopadding">
                ...
                <form action="<?php echo current_url(); ?>" id="formProduto" method="post" class="form-horizontal">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="precoCompra" class="money" type="text" name="precoCompra"
                                   value="<?php echo number_format($result->precoCompra, 2, ',', '.'); ?>"/>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="precoVenda" class="money" type="text" name="precoVenda"
                                   value="<?php echo number_format($result->precoVenda, 2, ',', '.'); ?>"/>
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="form-actions">
                        <div class="span12">
                            <div class="span6 offset3">
                                <a href="<?php echo base_url() ?>index.php/produtos" id="" class="btn btn-default btn-sm"><i
