                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        <div class="span8 offset2" style="text-align: center">
                                            <?php if ($result->faturado == 0) { ?>
                                                ...
                                                <button class="btn btn-primary btn-sm" id="btnContinuar"><i class="fa fa-check fa-fw"></i> Alterar
                                                </button>
                                                <a href="#modal-faturar" id="btn-faturar" data-toggle="modal" class="btn btn-success btn-sm"><i
                                                            class="fa fa-file-text-o fa-fw"></i> Faturar</a>
                                            <?php } ?>
                                            <a href="<?php echo base_url() ?>index.php/vendas/visualizar/<?php echo $result->idVendas; ?>"
                                               class="btn btn-inverse btn-sm"><i class="fa fa-search-plus fa-fw"></i> Visualizar Venda</a>
                                        </div>
                                    </div>
                                </form>
                                <div class="span12 well" style="padding: 1%; margin-left: 0">
                                    <form id="formProdutos" action="<?php echo base_url(); ?>index.php/vendas/adicionarProduto" method="post">
                                        ...
                                        <div class="span2">
                                            ...
                                            <button class="btn btn-success btn-sm btn-block" id="btnAdicionarProduto"><i
                                ...
                                <div class="span12" id="divProdutos" style="margin-left: 0">
                                    <table class="table table-bordered" id="tblProdutos">
                                        ...
                                        foreach ($produtos as $p) {
                                            ...
                                            echo '<td style="text-align: center"><a href="" idAcao="' . $p->idItens . '" prodAcao="' . $p->idProdutos . '" quantAcao="' . $p->quantidade . '" title="Excluir Produto" class="btn btn-danger btn-xs"><i class="fa fa-trash-o fa-lg fa-fw"></i></a></td>';
...
<div id="modal-faturar" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <form id="formFaturar" action="<?php echo current_url() ?>" method="post">
        <div class="modal-header bg_success">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            <h3 id="myModalLabel">FATURAR VENDA</h3>
        </div>
        <div class="modal-body">
            <div class="span12 alert alert-info" style="margin-left: 0">* Preenchimento obrigatório.</div>
