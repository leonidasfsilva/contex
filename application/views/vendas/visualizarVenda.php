    ...
    <div class="span12">
        <div class="widget-box">
            <div class="widget-title">
                ...
                <h5>Venda</h5>
                <div class="buttons">
                    <a href="<?= base_url() ?>index.php/vendas" class="btn btn-default btn-sm"><i class="fa fa-arrow-left fa-fw"></i> Voltar</a>
                    <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'eVenda')) {
                        echo '<a title="Editar Venda" class="btn btn-sm btn-primary" href="' . base_url() . 'index.php/vendas/editar/' . $result->idVendas . '">
                                <i class="fa fa-edit fa-fw"></i> Editar</a>';
                    } ?>
                    <a target="_blank" title="Imprimir" class="btn btn-sm btn-inverse"
                       href="<?php echo site_url() ?>/vendas/imprimir/<?php echo $result->idVendas; ?>"><i class="fa fa-print fa-fw"></i> Imprimir</a>
                </div>
            </div>
                            ...
                            <?php if ($emitente == null) { ?>
                                <tr>
                                    <td colspan="3" class="alert">Você precisa configurar os dados do emitente. >>><a
                                                href="<?php echo base_url(); ?>mxcode/emitente">Configurar</a><<<
                                    </td>
                                </tr>
                            <?php } else { ?>
                                <tr>
