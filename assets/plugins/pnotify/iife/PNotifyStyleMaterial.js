var _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
    ...
    return t
}, PNotifyStyleMaterial = function (t) {
    "use strict";
    ...
    function o(t) {
        !function (t, i) {
            t._handlers = a(), t._slots = a(), t._bind = i._bind, t._staged = {}, t.options = i, t.root = i.root || t, t.store = i.store || t.root.store, i.root || (t._beforecreate = [], t._oncreate = [], t._aftercreate = [])
        }(this, t), this._state = e({}, t.data), this._intro = !0, document.getElementById("svelte-19og8nx-style") || i(), this._fragment = (this._state, {c: r, m: r, p: r, d: r}), t.target && (this._fragment.c(), this._mount(t.target, t.anchor))
    }
    ...
    return t = t && t.__esModule ? t.default : t, e(o.prototype, {
        destroy: function (t) {
            this.destroy = r, this.fire("destroy"), this.set = r, this._fragment.d(!1 !== t), this._fragment = null, this._state = {}
        }, get: function () {
            return this._state
        }, fire: function (t, i) {
            var o = t in this._handlers && this._handlers[t].slice();
            if (!o) return;
            for (var n = 0; n < o.length; n += 1) {
                var r = o[n];
                if (!r.__calling) try {
                    r.__calling = !0, r.call(this, i)
                } finally {
                    r.__calling = !1
                }
            }
        }, on: function (t, i) {
            var o = this._handlers[t] || (this._handlers[t] = []);
            return o.push(i), {
                cancel: function () {
                    var t = o.indexOf(i);
                    ~t && o.splice(t, 1)
            ...
            if (this._set(e({}, t)), this.root._lock) return;
            !function (t) {
                t._lock = !0, f(t._beforecreate), f(t._oncreate), f(t._aftercreate), t._lock = !1
            }(this.root)
        }, _set: function (t) {
            var i = this._state, o = {}, n = !1;
            for (var r in t = e(this._staged, t), this._staged = {}, t) this._differs(t[r], i[r]) && (o[r] = n = !0);
            if (!n) return;
            this._state = e(e({}, i), t), this._recompute(o, this._state), this._bind && this._bind(o, this._state);
            this._fragment && (this.fire("state", {changed: o, current: this._state, previous: i}), this._fragment.p(o, this._state), this.fire("update", {changed: o, current: this._state, previous: i}))
        }, _stage: function (t) {
            e(this._staged, t)
        }, _mount: function (t, i) {
            this._fragment[this._fragment.i ? "i" : "m"](t, i || null)
        }, _differs: function (t, i) {
            return t != t ? i == i : t !== i || t && "object" === (void 0 === t ? "undefined" : _typeof(t)) || "function" == typeof t
        }
    }), o.prototype._recompute = r, (n = o).key = "StyleMaterial", t.modules.StyleMaterial = n, t.modulesPrependContainer.push(n), t.styling.material || (t.styling.material = {}), t.styling.material = _extends(t.styling.material, {
    ...
    }), t.icons.material || (t.icons.material = {}), t.icons.material = _extends(t.icons.material, {
